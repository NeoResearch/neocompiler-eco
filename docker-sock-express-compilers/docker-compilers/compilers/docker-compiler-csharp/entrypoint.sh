...
(cd /neo-devpack-dotnet/ && dotnet build ./templates/Template.CSharpNeoCompiler/) >> /tmp/output.txt
...
if [ -f /neo-devpack-dotnet/templates/Template.CSharpNeoCompiler/bin/sc/Contract1.nef ]; then
   cat /neo-devpack-dotnet/templates/Template.CSharpNeoCompiler/bin/sc/Contract1.nef | base64 -w 0 >> /tmp/return.txt
fi
#echo -n "\", \"abi\":\"" >> /tmp/return.txt
#if [ -f /neo-devpack-dotnet/templates/Template.CSharpNeoCompiler/bin/sc/Template.CSharpNeoCompiler.abi.json ]; then
#   cat /neo-devpack-dotnet/templates/Template.CSharpNeoCompiler/bin/sc/Template.CSharpNeoCompiler.abi.json | base64 -w 0 >> /tmp/return.txt
#fi
echo -n "\", \"manifest\":\"" >> /tmp/return.txt
if [ -f /neo-devpack-dotnet/templates/Template.CSharpNeoCompiler/bin/sc/Contract1.manifest.json ]; then
   cat /neo-devpack-dotnet/templates/Template.CSharpNeoCompiler/bin/sc/Contract1.manifest.json | base64 -w 0 >> /tmp/return.txt
fi
