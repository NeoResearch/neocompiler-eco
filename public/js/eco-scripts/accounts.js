...
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: new Neon.wallet.Account("KxDgvEKzgSBPPfuVfw67oPQBSjidEiqTHURKSDL1R7yGaGYAeYnr"), print: true });
//APLJBPhtRg2XLhtpxEHd6aRNL7YSLGH2ZL
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: new Neon.wallet.Account("L56SWKLsdynnXTHScMdNjsJRgbtqcf9p5TUgSAHq242L2yD8NyrA"), print: true });
//AXxCjds5Fxy7VSrriDMbCrSRTxpRdvmLtx
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: new Neon.wallet.Account("KwNkjjrC5BLwG7bQuzuVbFb5J4LN38o1A8GDX4eUEL1JRNcVNs9p"), print: true });
//AQaJZTKshTQzcCKmsaoNVrtSP1pEB3Utn9
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: new Neon.wallet.Account("KxPHsCAWkxY9bgNjAiPmQD87ckAGR79z41GtwZiLwxdPo7UmqFXV"), print: true });
...
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: accountMS1, print: false});
//Node2
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: accountMS2, print: false});
//Node3
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: accountMS3, print: false}); 
//Node4
ECO_WALLET.push({ type: 'commonAddress', addressBase58: '', account: accountMS4, print: false}); 
// ==============================================================================================
...
ECO_WALLET.push({ type: 'multisig', addressBase58: '', account: genesisMultiSigAccount, print: true,
owners: '' });
