...
app.get('/statusnode1', function(req, res) {
  ...
  var cmddocker = 'cat ./docker-compose-eco-network/logs-neocli-node1/*.log | tail -n 500';
...
app.get('/statusnode2', function(req, res) {
  ...
  var cmddocker = 'cat ./docker-compose-eco-network/logs-neocli-node2/*.log | tail -n 500';
  var child = require('child_process').exec(cmddocker, optionsCompile, (e, stdout1, stderr)=> {
    if (e instanceof Error) {
      res.send("Error:"+e);
      console.error(e);
...
app.get('/statusnode3', function(req, res) {
  ...
  var cmddocker = 'cat ./docker-compose-eco-network/logs-neocli-node3/*.log | tail -n 500';
  var child = require('child_process').exec(cmddocker, optionsCompile, (e, stdout1, stderr)=> {
    if (e instanceof Error) {
      res.send("Error:"+e);
      console.error(e);
...
app.get('/statusnode4', function(req, res) {
  ...
  var cmddocker = 'cat ./docker-compose-eco-network/logs-neocli-node4/*.log | tail -n 500';
  var child = require('child_process').exec(cmddocker, optionsCompile, (e, stdout1, stderr)=> {
    if (e instanceof Error) {
      res.send("Error:"+e);
      console.error(e);
