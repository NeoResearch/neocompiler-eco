...
if (($BUILD_CSHARP)); then
	echo -e "\nBUILDING BUILDING mono-neo-compiler $BUILD_CSHARP"
...
if (($BUILD_GO)); then
	echo -e "\nBUILDING BUILDING neo-go-compiler"
