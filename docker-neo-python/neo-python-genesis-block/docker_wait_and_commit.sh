...
CONTAINER_NAME_PRELOADED="neo-csharp-nodes"

echo "Committing docker image as neo-privatenet:latest"
docker commit $CONTAINER_NAME $CONTAINER_NAME_PRELOADED:latest

echo "Next steps:"
echo "- docker tag $CONTAINER_NAME_PRELOADED:latest cityofzion/neo-privatenet:latest"
echo "- docker tag $CONTAINER_NAME_PRELOADED:latest cityofzion/neo-privatenet:<version>"
echo "- docker push cityofzion/$CONTAINER_NAME_PRELOADED:latest cityofzion/neo-privatenet:<version>"
