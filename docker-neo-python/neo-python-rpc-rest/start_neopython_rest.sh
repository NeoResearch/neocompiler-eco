...
screen -L -Logfile /neo-python/logs/restScreen.log -dmS restScreen /usr/bin/python3 /neo-python/neo/bin/api_server.py --datadir /root/.neopython/ --privnet --logfile /neo-python/logs/saida.log  --port-rest 8080 #--port-rpc 10332
